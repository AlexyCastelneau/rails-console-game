class Perso < ApplicationRecord
  ...
  def set_gear(arguments) # à ajuster quand il y aura les classes
    ...
    head = Item.new_item({consumable: false, slot: "head", type: "light", dmg: 0, armor: 1, str: 0, dex: 0, vit: 0, int: 0, wis: 0 })
    body = Item.new_item({consumable: false, slot: "body", type: "light", dmg: 0, armor: 1, str: 0, dex: 0, vit: 0, int: 0, wis: 0 })
    hands = Item.new_item({consumable: false, slot: "hands", type: "light", dmg: 0, armor: 1, str: 0, dex: 0, vit: 0, int: 0, wis: 0 })
    legs = Item.new_item({consumable: false, slot: "legs", type: "light", dmg: 0, armor: 1, str: 0, dex: 0, vit: 0, int: 0, wis: 0 })
    feet = Item.new_item({consumable: false, slot: "feet", type: "light", dmg: 0, armor: 1, str: 0, dex: 0, vit: 0, int: 0, wis: 0 })
    primary_weapon = Item.new_item({consumable: false, slot: "primary_weapon", type: "1H_sword", dmg: 5, armor: 0, str: 0, dex: 0, vit: 0, int: 0, wis: 0 })
  ...
  def set_geared_stats
    ...
    stats = geared.keys
    keys.each { |slot| stats.each { |stat| geared[stat] += gear[slot][stat] } }
